...
//      {key : 'id', value: 'Id', visible: true},
    ...
    service.songList = [
      {id : '001', name: 'Song 1', artist: 'A ', viewCount: 0, checked: false},
      {id : '002', name: 'Song 2', artist: 'B ', viewCount: 99, checked: false},
      {id : '003', name: 'Song 3', artist: 'C ', viewCount: 999,  checked: false}
    ];
