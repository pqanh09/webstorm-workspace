/**
 * Created by dminhquan on 9/9/14.
 */
(function ($) {
  // register namespace
  $.extend(true, window, {
    'Slick': {
      'OvDataViewRowSelectionModel': OvDataViewRowSelectionModel
    }
  });

  function OvDataViewRowSelectionModel(options) {
    var _grid;
    var _dataGridView;
    var _ranges = [];
    var _self = this;
    ...
    function handleClick(e) {
      var cell = _grid.getCellFromEvent(e), i, j;
      ...
      if(pageInfo.oldVal.pageSize !== 0 && pageInfo.oldVal.pageSize !== _dataGridView.getItems().length){
        currIds = _dataGridView.mapRowsToIds(selection);
        ...
        _ranges = rowsToRanges(_dataGridView.mapIdsToRows(currSelectedIds));
      }else{
