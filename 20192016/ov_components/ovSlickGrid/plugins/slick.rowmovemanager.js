(function ($) {
  ...
  function RowMoveManager(options) {
    ...
    function handleDragStart(e, dd) {
      ...
      selectedRows = _self.realSelectedRows(selectedRows);
      ...
      dd.selectionProxy = $("<div class='slick-reorder-proxy'></div>")
        ...
        .css("top", e.pageY - $(_canvas).offset().top)
        .appendTo(_canvas);
      dd.selectionProxy = _self.customProxy(dd, rowHeight);
    ...
    $.extend(this, {
      ...
      "canDragNDrop": function (e, dd) {
        return true;
      },
      "realSelectedRows": function (rows) {
        return rows;
      },
      "customProxy": function (dd, h) {
        return dd;
      },
