  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function updateCanvasWidth(forceColumnWidthsUpdate) {
      ...
      if (widthChanged || options.frozenColumn > -1 || hasFrozenRows) {
        ...
        viewportHasHScroll = true;// (canvasWidth > viewportW - scrollbarDimensions.width);
      }
    ...
    function setFrozenOptions() {
      ...
      if (options.frozenRow > -1) {
        ...
        var dataLength = 0;
        try {
          dataLength = getDataLength() || this.data.length;
        } catch (err) {
    ...
    function createCssRules() {
      ...
      addCSSRule(sheet, "." + uid + " .slick-cell", "height:" + rowHeight + "px; line-height:" + rowHeight + "px;", index++);
    ...
    function handleClick(e) {
      ...
      if ((activeCell != cell.cell || activeRow != cell.row) && canCellBeActive(cell.row, cell.cell)) {
        if (!getEditorLock().isActive() || getEditorLock().commitCurrentEdit()) {
          if (hasFrozenRows || options.frozenRow === -1) {
